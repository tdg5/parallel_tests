          ...
          if /ruby -Itest/ === cmd
            ...
            begin
              ...
              script = [
                ...
                "export PARALLEL_TEST_PROCESSORS=#{ENV["PARALLEL_TEST_PROCESSORS"]}",
                "echo 'PARALLEL_TEST_PROCESSORS=#{ENV["PARALLEL_TEST_PROCESSORS"]} TEST_ENV=#{env} TEST_SCRIPT=#{cmd_file}'",
